...
tellraw @a[scores={help=4}] [{"text":"\nBetter Armor Stands","underlined":true,"color":"dark_aqua"},{"text":" (v5.0.0)\n","underlined":false}]
tellraw @a[scores={help=4}] [{"text":"Better Amor Stands provides you with a book that will allow you to modify, move and position armor stands in many different ways or make your item frames invisible."}]
